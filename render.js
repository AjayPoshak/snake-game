...
class Render {
  ...
  userInputHandler(event) {
    ...
    switch (key) {
      case 'ArrowRight': {
        if (this.lastAction === 'MOVE_RIGHT' || this.lastAction === 'MOVE_LEFT')
          return false
      ...
      case 'ArrowLeft': {
        if (this.lastAction === 'MOVE_LEFT' || this.lastAction === 'MOVE_RIGHT')
          return false
      ...
      case 'ArrowUp': {
        if (this.lastAction === 'MOVE_UP' || this.lastAction === 'MOVE_DOWN')
          return false
      ...
      case 'ArrowDown': {
        if (this.lastAction === 'MOVE_DOWN' || this.lastAction === 'MOVE_UP')
          return false
  ...
  playGame(evt) {
    this.removeTimer = timer(
      this.updateUIAfterInterval.bind(this),
      this.refreshTime
    )
  }
